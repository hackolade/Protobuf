...
OneofContext.prototype.COMMENT = function () {
...
ServiceDefContext.prototype.COMMENT = function () {
  return this.getToken(Protobuf3Parser.COMMENT, 0);
};
...
RpcContext.prototype.COMMENT = function () {
  return this.getToken(Protobuf3Parser.COMMENT, 0);
};
...
RpcContext.prototype.lineComment = function (i) {
  if (i === undefined) {
    i = null;
  }
  if (i === null) {
