...
FieldLineCommentContext.prototype = Object.create(antlr4.ParserRuleContext.prototype);
...
Protobuf3Parser.prototype.fieldLineComment = function () {
	...
	try {
		...
		if (!!this.isPreviousTokenOnHiddenChannel()) {
			throw new antlr4.error.FailedPredicateException(this, ' !this.isPreviousTokenOnHiddenChannel() ');
		}
		this.state = 607;
		this.match(Protobuf3Parser.LINE_COMMENT);
	} catch (re) {
...
Protobuf3Parser.prototype.fieldLineComment_sempred = function (localctx, predIndex) {
	switch (predIndex) {
		case 0:
